...
//	}
	...
	private String generateOperation(NodoArbol nodo) {
		...
		case "/":
			...
			boolean negative = ((String)_tds.getTupla(arg1).getValue("valor")).startsWith("-");
			arg1 = procArgument(arg1);
			arg2 = procArgument(arg2);

			code += "mov "+reg+", "+arg1+'\n';
			
			int nLabel1 = apiloLabel(),
					nLabel2 = apiloLabel();		
			desapiloLabel();desapiloLabel();
			
			code += "cmp "+reg+", 0 \n";
			code += "JGE label_"+nLabel1+'\n';
			code += (entero ? "cwd" : "cwde") + '\n' ;
			code += "jmp label_"+nLabel2+'\n';
			code += "label_"+nLabel1+": \n";
			code += "mov "+reg2+", 0 \n";
			code += "label_"+nLabel2+": \n";
