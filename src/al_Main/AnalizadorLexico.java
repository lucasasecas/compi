...
public class AnalizadorLexico {
	...
	public void initMatrix(){
		...
		matriz[1][0] = new Estado(1);   matriz[1][0].addAction(ac2); 
 		...
 		matriz[6][2] =  new Estado(-1);
 		matriz[6][3] =  new Estado(-1);
 		matriz[6][4] =  new Estado(-1); 
 		matriz[6][5] =  new Estado(-1);
 		matriz[6][6] =  new Estado(-1); 
 		matriz[6][7] =  new Estado(-1); 
 		matriz[6][8] =  new Estado(-1); 
 		matriz[6][9] =  new Estado(-1);
 		matriz[6][10] = new Estado(-1);
 		matriz[6][11] = new Estado(-1);
 		matriz[6][12] = new Estado(-1);
 		matriz[6][13] = new Estado(-1);
 		matriz[6][14] = new Estado(-1);
 		matriz[6][15] = new Estado(-1);
 		...
 		matriz[8][2] =  new Estado(-1);
 		matriz[8][3] =  new Estado(-1);
 		matriz[8][4] =  new Estado(-1);
 		matriz[8][5] =  new Estado(-1);
 		matriz[8][6] =  new Estado(-1);
 		matriz[8][7] =  new Estado(-1);
 		matriz[8][8] =  new Estado(-1);
 		matriz[8][9] =  new Estado(-1);
 		matriz[8][10] = new Estado(-1);
 		matriz[8][11] = new Estado(-1);
 		matriz[8][12] = new Estado(-1);
 		matriz[8][13] = new Estado(-1);
 		matriz[8][14] = new Estado(-1);
 		matriz[8][15] = new Estado(-1);
 		matriz[8][16] = new Estado(-1);
 		matriz[8][17] = new Estado(-1);
 		matriz[8][18] = new Estado(-1);
 		matriz[8][19] = new Estado(-1);
